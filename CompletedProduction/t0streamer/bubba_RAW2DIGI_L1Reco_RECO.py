...
# with command line options: bubba --conditions auto:run2_data -s RAW2DIGI,L1Reco,RECO --runUnscheduled --process RECO --data --eventcontent FEVT --scenario pp --datatier RECO --customise Configuration/DataProcessing/RecoTLR.customiseDataRun2Common_25ns -n -1 --no_exec --filein file:run261396_ls0002_streamExpress_StorageManager.root
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:run261396_ls0002_streamExpress_StorageManager.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('bubba nevts:-1'),
...
process.FEVToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('bubba_RAW2DIGI_L1Reco_RECO.root'),
