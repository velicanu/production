...
## 1. Setup cmssw for forest
Follow these instructions: https://twiki.cern.ch/twiki/bin/viewauth/CMS/HiForestSetup#Setup_for_7_5_X 
...
## 4. Edit the crabConfig.py for the current production
these lines specifically, make sure to KEEP \_PTMINFLAG_ which is automatically set later :
```python
...
## 7. once the jobs finish running
merge them with hadd and document the samples on the HiForest twiki: https://twiki.cern.ch/twiki/bin/view/CMS/HiForest2015 
