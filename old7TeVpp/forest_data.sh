...
filename="$1"
config_filename=run_forest_`basename "$filename" .root`.py
output_filename=`basename "$filename"`
output_dirname=/net/hisrv0001/home/dav2105/forest/CMSSW_5_3_20/src/"`dirname \"$output_filename\"`"
[ -d "$output_dirname" ] || mkdir -p "$output_dirname"
cd /net/hisrv0001/home/dav2105/forest/CMSSW_5_3_20/src
...
EOF
if [ -f /afs/cern.ch/user/y/ylai/.x509up_u22918 ]; then
    export X509_USER_PROXY=/afs/cern.ch/user/y/ylai/.x509up_u22918
fi
eval `scramv1 runtime -sh`
cmsRun "$config_filename"
exit 0
